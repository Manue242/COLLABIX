...
. Routage Sécurisé & Contrat d'Interface
...
Requêtes 1 à 10 : Traitées normalement par l'application (Statut HTTP 201 ou 401/200 selon la validité).
À partir de la 11ème requête (T+0.1s) : Le bouclier se lève. L'infrastructure bloque l'accès et renvoie instantanément un code d'erreur HTTP 429 Too Many Requests.
